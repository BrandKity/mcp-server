        ...
        .array(
          z.object({
            ...
            usage: z
              ...
              .optional()
              .describe(
                "Role of this font. One of: 'Headings', 'Body text', 'Display', 'Caption', 'UI'"
              ),
            ...
            asset_url: z
              ...
              .optional()
              .describe(
                'For Custom source: URL from upload_file tool. For Adobe Fonts: Typekit CSS URL (https://use.typekit.net/xxx.css).'
              ),
          })
        )
