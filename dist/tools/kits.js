...
export function registerKitTools(server, client) {
    ...
    // ── update_kit ──
    server.tool('update_kit', "Update a kit's top-level settings like name, accent color, template, tagline, logo, or cover image. For logo_url and cover_image_url, pass CDN URLs returned by upload_file or upload_asset.", {
        kit_id: z.string().describe('Kit UUID'),
