...
export function registerUploadTools(server, client) {
    ...
    server.tool('upload_asset', [
        ...
        file_path: z
            .string()
            .describe("Absolute path to the local file, e.g. '/Users/jane/Projects/AcmeCorp/logos/acme-primary.svg'"),
        block_type: z
        ...
        variant_name: z
            .string()
            .optional()
            .describe('For logos blocks only — the logo variant slot name, e.g. "Primary", "Horizontal", "Icon Mark", "Mono", "Reversed". Defaults to first empty slot.'),
        collateral_title: z
            .string()
            .optional()
    ...
    }, async ({ kit_id, block_id, file_path, block_type, variant_name, collateral_title, collateral_description, resource_label, resource_category, }) => {
        try {
    ...
    // ── upload_cover_image ──
    server.tool('upload_cover_image', [
